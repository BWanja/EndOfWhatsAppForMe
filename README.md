...
Jetzt fragst du sicherlich: Warum nutzen wir das nicht? Naja, da sind wir wieder bei den Nutzerentscheidungen. Zu vielen Nutzern ist ihre Privatsphäre einfach völlig egal, es ist ja "nur" unbedeutende private Chatkommunikation. In der Folge hat auch XMPP als Protokoll noch kleine Schwächen in Sachen Datenschutz, zB im Bereich [Metadaten](https://www.kuketz-blog.de/conversations-messaging-ueber-das-xmpp-protokoll-messenger-teil6/), da die Weiterntwicklung von XMPP stark von den Anforderungen der Community getrieben ist.
